...
const SwitchIOSComponent = ({ checked, label, height = 26, ref }) => {
   ...
   return <FormControlLabel control={<IOSSwitch sx={{ m: 0, p: 0, mr: 1 }} defaultChecked={checked} />} label={label} ref={ref} />;
};
